...
@section('content')
    <div class=" dark:text-white">
        <div class="items-center justify-between px-2 pt-3 lg:py-3 lg:px-0 lg:flex dark:border-gray-800">
            <div>
                <h4 class='text-xl font-semibold '>Color List</h4>
                <p class="py-1 text-sm text-gray-400">Showing colors added recently.</p>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.deleteBtn', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: 'You will not recover this color details!',
                    icon: 'warning',
