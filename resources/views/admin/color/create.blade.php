<div x-data="{ modelOpen: false }" id="colorModal">
    ...
    <div x-show="modelOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            >
                ...
                <form method="post" class="mt-5" id="colorForm">
                    @csrf
                    <div class="mb-2 space-y-2">
                        <div>
                            ...
                            <input type="text" name="color_name" value="{{ old('color_name') }}"
                                ...
                                <span class="hidden text-xs text-red-600" id="color_name_error"></span>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#colorForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.product.color.store') }}",
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            $('#colorModal').attr('x-data', '{modelOpen:false}')
