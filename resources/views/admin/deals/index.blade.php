...
@section('content')
    <div class=" dark:text-white">
        <div class="items-center justify-between px-2 pt-3 lg:py-3 lg:px-0 lg:flex dark:border-gray-800">
            <div>
                <h4 class='text-xl font-semibold '>Deals List</h4>
                <p class="py-1 text-sm text-gray-400">Showing deals added recently.</p>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $("#data-table").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.promotion.deals.index') }}",
                    data: function(d) {
                        d.status = $('#status').val(),
            ...
            $(document).on('click', '.deleteBtn', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: 'You will not recover this brand details!',
                    icon: 'warning',
