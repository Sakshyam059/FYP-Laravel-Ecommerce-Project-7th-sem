...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto text-sm bg-white border-r dark:bg-gray-800 md:block">
    <div class="text-gray-500 dark:text-gray-400">
        <div class="py-5 ">
            <a href="{{route('homepage')}}" class="ml-6 text-2xl font-bold text-gray-800 dark:text-gray-200" href="#">
                Khelretail
            </a>
        </div>
        <ul class="px-3 space-y-2">
            ...
            <li>
                <button
                    class="{{ Request::routeIs('admin.marketing.*')?'border border-black/50 bg-blue-800/75 text-white  dark:bg-gray-700 ':''}}relative p-2 inline-flex gap-2 items-center w-full rounded border-none   font-semibold  transition-colors duration-150 border  hover:text-gray-800 dark:hover:text-gray-200 text-gray-800 dark:text-gray-200"
                    @click="toggleMarketingMenu" aria-haspopup="true">
                ...
                <template x-if="isMarketingMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        x-transition:enter-start="opacity-25 max-h-0" x-transition:enter-end="opacity-100 max-h-xl"
                        x-transition:leave="transition-all ease-in-out duration-300"
                        x-transition:leave-start="opacity-100 max-h-xl" x-transition:leave-end="opacity-0 max-h-0"
                        ...
                        <li
                            class="{{ Request::routeIs('admin.marketing.banner.*')?'border border-black/50 bg-blue-400/75 dark:bg-gray-700 ':''}} py-2 px-6 inline-flex gap-2 items-center w-full rounded border-none   font-semibold  transition-colors duration-150 border  hover:text-gray-800 dark:hover:text-gray-200 text-gray-800 dark:text-gray-200">
                            <a href="{{route('admin.marketing.banner.index')}}"  href="pages/forgot-password.html">
                                Banners
                            </a>
                        </li>
            ...
            <li>
                <a href="{{route('admin.profile.edit')}}" class="{{ Request::routeIs('admin.profile.edit')?'border border-black/50 text-white bg-blue-800/75 dark:bg-gray-700 ':''}} inline-flex items-center w-full gap-2 p-2 font-semibold text-gray-800 transition-colors duration-150 border border-none rounded hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-200"
                    href="{{route('admin.dashboard')}}" >
