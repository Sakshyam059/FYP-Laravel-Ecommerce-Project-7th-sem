<div x-data="{ modelOpen: false }" id="brandModal">
        ...
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            >
                <div class="relative flex items-center justify-between space-x-4">
                    <h1 class="text-xl font-medium text-gray-800 ">Add New Color</h1>
                ...
                <form method="post" class="mt-5" id="brandForm">
                    @csrf
                    <div class="mb-2 space-y-2">
                        <div>
                            <label for="">Brand Name</label>
                            <input type="text" name="brand_name" value="{{ old('brand_name') }}"
                                placeholder="Enter brand name" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                        </div>
                        <span class="hidden text-xs text-red-600" id="brand_name_error"></span>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            $('#brandModal').attr('x-data', '{modelOpen:false}')
