    ...
    <div class=" dark:text-white">
        ...
        <div>
            <button id="bulkDelete"
                ...
                <span class="inline-flex items-center gap-2 text-sm"><i class='bx bx-trash'></i> <span>Delete all</span></span>
            </button>
            <div class="flex items-center gap-3 px-4 lg:px-0" id="table-options">
                    ...
                    <div x-cloak x-show="open" @click.away="open = false"
                        ...
                        <form class="p-3" id="filterForm">
                            ...
                            <div class="grid grid-cols-2 gap-3 mt-2 ">
                                <input type="text" class="py-1 text-sm" placeholder="Min" id="min">
                                <input type="text" class="py-1 text-sm" placeholder="Max" id="max">
                            </div>
                        </form>
                        <div class="p-3 pt-0">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $("#data-table").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('vendor.product.index') }}",
                    data: function(d) {
                        d.status = $('#status').val(),
                            d.min = $('#min').val(),
                            d.max = $('#max').val(),
