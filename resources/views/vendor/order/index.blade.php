...
@section('content')
    <div class=" dark:text-white">
        <div class="items-center justify-between px-2 pt-3 lg:py-3 lg:px-0 lg:flex dark:border-gray-800">
            <div>
                <h4 class='text-xl font-semibold '>Order List</h4>
                <p class="py-1 text-sm text-gray-400">Showing orders received recently.</p>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $("#data-table").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('vendor.order.index') }}",
                    data: function(d) {
                        d.delivery_status = $('#status').val()
                    }
                },
                columns: [
                    {
