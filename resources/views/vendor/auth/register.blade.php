...
@section('content')
    <div class="p-6 -mt-3 bg-green-300">
       
        <div class="w-9/12 p-6 mx-auto space-y-4 bg-white border rounded">
            ...
            <form action="{{ route('vendor.auth.register') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="space-y-2 ">
                        <label class="block " for="form3Example1m">Company Email  <small class="text-red-600">*</small></label>
                        <input type="text" id="form3Example1m" class="block w-full rounded-md bg-gray-50 "
                            name="email" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-2 ">
                        <label class="block " for="form3Example1m">Company Phone  <small class="text-red-600">*</small></label>
                        <input type="text" id="form3Example1m" class="block w-full rounded-md bg-gray-50 "
                            name="phone" />
                    </div>
                    <div class="space-y-2 ">
                        <label class="block " for="form3Example1n">Company Address  <small class="text-red-600">*</small></label>
                        <input type="text" id="form3Example1n" class="block w-full rounded-md bg-gray-50 "
                            name="address" />
                    </div>
                </div>
                <div class="space-y-2 ">
                    <label class="block " for="form3Example8">Company Logo  </label>
                    <input type="file" name="logo" />
                </div>
                <div class="space-y-2 ">
                    <label class="block " for="form3Example8">Company Description</label>
                    <textarea class="w-full rounded-md bg-gray-50" name="description" id="" cols="30" rows="2"></textarea>
                </div>
