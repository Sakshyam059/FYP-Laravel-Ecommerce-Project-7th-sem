        ...
        <div class="grid gap-2 mx-auto lg:grid-cols-3">
            <div class="relative overflow-hidden h-44">
                <img class="object-cover w-full rounded h-44"
                    src="{{asset('admin/assets/static/images/banner-1.jpg')}}"
                    alt="">

                <div class="absolute px-3 py-3 space-y-3 top-3">
            ...
            <div class="relative overflow-hidden h-44">
                <img class="object-cover w-full rounded h-44"
                    src="{{asset('admin/assets/static/images/banner-4.jpg')}}"
                    alt="">
            ...
            <div class="relative overflow-hidden h-44">
                <img class="object-cover w-full rounded h-44"
                    src="{{asset('admin/assets/static/images/banner-3.jpg')}}"
                    alt="">
