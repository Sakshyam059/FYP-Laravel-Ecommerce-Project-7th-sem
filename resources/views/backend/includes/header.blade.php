<header class="z-10 py-4 bg-white border-b dark:bg-gray-800">
    <div
        ...
        <!-- Search input -->
        <div class="flex flex-1 px-3 lg:mr-32">
            ...
            <li class="relative">
                ...
                <template x-if="isNotificationsMenuOpen">
                    <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        ...
                        class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-b border-gray-100 rounded-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700">
                        <li class="flex">
            ...
            <li class="relative">
                ...
                <template x-if="isProfileMenuOpen">
                    <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        ...
                        class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-b border-gray-100 rounded-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700"
                        aria-label="submenu">
                        <li class="flex">
